...
int main(int argc, char *argv[])
{
        ...
        tracks[0] = new_track(client, "track1", tapeLength, "track1:in");
        tracks[1] = new_track(client, "track2", tapeLength, "track2:in");
        tracks[2] = new_track(client, "track3", tapeLength, "track3:in");
