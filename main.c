...
static int tapeLength = 14400000; // 5 min
int track_count = 3;
...
int main(int argc, char *argv[])
{
        ...
        tracks[0] = new_track(client, "track1", tapeLength, "track1");
        tracks[1] = new_track(client, "track2", tapeLength, "track2");
        tracks[2] = new_track(client, "track3", tapeLength, "track3");
